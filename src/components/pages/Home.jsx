      ...
      <div className={styles.main}>
        ...
        >
          <a href="https://uwttn.github.io/portfolio/">
            <strong className={styles.links}>Portfolio</strong>
          </a>
          <img
            src="https://github.com/Uwttn/portfolio/blob/main/assets/website-view.png?raw=true"
            style={{ height: "100%" }}
          />
          <a href="https://github.com/Uwttn/portfolio"><strong className={styles.links}>Repository</strong></a>
        </div>
        {/* Payroll */}
        <div
          className="card bg-primary-subtle"
        ...
        >
          <a href="https://uwttn.github.io/payroll/">
            <strong className={styles.links}>Payroll</strong>
          </a>
          <img
            src="https://raw.githubusercontent.com/Uwttn/payroll/main/assets/image.png"
            style={{ height: "100%" }}
          />
          <a href="https://github.com/Uwttn/payroll"><strong className={styles.links}>Repository</strong></a>
        </div>
        {/* weather */}
        <div
          className="card bg-primary-subtle"
        ...
        >
          <a href="https://uwttn.github.io/weather/">
            <strong className={styles.links}>Weather</strong>
          </a>
          <img
            ...
            style={{ height: "100%" }}
          />
          <a href="https://github.com/Uwttn/weather"><strong className={styles.links}>Repository</strong></a>
        </div>
        {/* FlipIt */}
        <div
          className="card bg-primary-subtle"
        ...
        >
          <a href="https://flipit-57ng.onrender.com/">
            <strong className={styles.links}>FlipIt</strong>
          </a>
          <img
            ...
            style={{ height: "100%" }}
          />
          <a href="https://github.com/AllredW/FlipIt"><strong className={styles.links}>Repository</strong></a>
        </div>
